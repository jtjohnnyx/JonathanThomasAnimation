...
class MainActivity : AppCompatActivity() {
    ...
    private var sundown by Delegates.notNull<Boolean>()
    ...
    private fun startAnimation() {
        ...
        val reflectionStart = binding.reflection.top.toFloat()
        val reflectionEnd = -1 * (binding.sea.height.toFloat())
        ...
        val reflectionAnimator = ObjectAnimator
            .ofFloat(binding.reflection, "y", reflectionStart, reflectionEnd)
            .setDuration(4350)
